...
//     // Fetch companies and their services (billing data)
//     useEffect(() => {
//         const fetchBillingData = async () => {
//             try {
...
//                             serviceName: service.serviceName,
//                             billingInstruction: service.billingInstruction,
//                             cost: service.yearlyCost,
//                             billingDate: new Date(service.billingDate).toLocaleDateString(),
//                             status: service.status || "Pending", // fallback if no status field
//                             serviceIndex: index,
//                         });
//                     });
//                 });
...
//                 axios
//                     .patch(`/api/company/${item.companyId}/service/${item.serviceIndex}`, {
//                         status: newStatus,
//                     })
//                     .then(() => {
//                         console.log("Status updated successfully");
...
//                             billingInstruction: service.billingInstruction,
//                             cost: service.cost,
//                             billingDate: new Date(service.nextBillingDate).toLocaleDateString(),
